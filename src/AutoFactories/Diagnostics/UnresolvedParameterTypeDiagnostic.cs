        ...
        public UnresolvedParameterTypeDiagnostic()
            : base(
                  ...
                  messageFormat:
                    ...
                    $"To fix this, you can either forward declare a matching partial class for '{{2}}' within the current codebase or avoid using source-generated types as parameters for factories. This ensures the source generator can properly analyze and process the code.")
        {
